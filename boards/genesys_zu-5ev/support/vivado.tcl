...
#connect_bd_net [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_lpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/saxihpc0_fpd_aclk]
...
add_files [pwd]/led_blinker.v
create_bd_cell -type module -reference led_blinker led_blinker_0
create_bd_port -dir O -from 3 -to 0 pl_leds_tri_o
connect_bd_net [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] [get_bd_pins led_blinker_0/clk]
connect_bd_net [get_bd_pins led_blinker_0/leds] [get_bd_ports pl_leds_tri_o]
